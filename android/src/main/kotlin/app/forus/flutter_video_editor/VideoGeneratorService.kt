...
import app.forus.flutter_video_editor.filter.GlImageOverlayFilter
import app.forus.flutter_video_editor.ImageOverlay
import io.flutter.plugin.common.MethodChannel.Result
import android.graphics.Paint.Align
import android.graphics.Paint.ANTI_ALIAS_FLAG
import app.forus.flutter_video_editor.filter.GlColorBlendFilter
import app.forus.flutter_video_editor.filter.GlTextOverlayFilter
    ...
    override fun writeVideoFile(processing: HashMap<String,HashMap<String,Any>>, result: Result, activity: Activity ) {
        ...
        composer.filter(GlFilterGroup( filters))
                .listener(object : Mp4Composer.Listener {
                    ...
                    override fun onCurrentWrittenVideoTime(p0: Long) {
